package be.dog.d.steven.multipurposeapp.views.main;
...
import be.dog.d.steven.multipurposeapp.views.chatview.ChatView;
import be.dog.d.steven.multipurposeapp.views.todoview.TodoView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "MultiPurposeApp", shortName = "MP-App",  enableInstallPrompt = false)
@Push
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "MultiPurposeApp logo"));
        logoLayout.add(new H1("MP-App"));
